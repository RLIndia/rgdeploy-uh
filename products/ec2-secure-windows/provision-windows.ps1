...
$rstudioURL = "https://cran.r-project.org/bin/windows/base/old/4.4.0/R-4.4.0-win.exe"
Invoke-WebRequest -Uri $rstudioURL -OutFile "C:\Users\Administrator\R-4.4.0-win.exe"
echo "Installing Rstudio..."
.\R-4.4.0-win.exe /VERYSILENT /NORESTART
...
# Install Notpad++
echo "installing notpad++ ..."
$notPadPPURL = "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.6.7/npp.8.6.7.Installer.x64.exe"
Invoke-WebRequest -Uri $notPadPPURL -OutFile npp.8.6.7.Installer.x64.exe
Start-Process -FilePath "C:\Users\Administrator\npp.8.6.7.Installer.x64.exe" -ArgumentList "/install /quiet /norestart /S" -Wait
